...

{
...

    {
        ...
        {
            $data['article'] = $this->knowledge_base_model->add_article($data);
        }
    ...
    public function add_article($slug)

    {
        ...
        $data['related_articles']      = $this->knowledge_base_model->add_article($data);
