...
foreach ($rResult as $aRow) {
    ...
    <input type="checkbox" data-switch-url="' . admin_url() . 'location/change_status" name="onoffswitch" class="onoffswitch-checkbox" id="' . $aRow['id'] . '" data-id="' . $aRow['id'] . '" ' . ($aRow['is_active'] == 1 ? 'checked' : '') . '>
