...
$result  = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, [], [db_prefix().'state.id as stateId',db_prefix().'state.name as statename',db_prefix().'state.country_id as statenamecountryID',db_prefix().'state.is_active as statestatus',db_prefix().'country.name as countryname','tblstate.state_code']);
