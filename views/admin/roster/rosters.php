				...
				<div class="panel_s">
					<div class="panel-body">
						<div class="no-margin">
                            <div class="row">
                                <div class="col-md-6">
									<a href="<?php echo admin_url('roster/add'); ?>" class="btn btn-info mright5 test pull-left display-block">
										<?php echo _l('new '.$title); ?>
									</a>
                                </div>
								<div class="col-md-3">
									<?= _l('Search By Day/Week/Month Wise'); ?>
                                    <select id="rday" class="form-control selectpicker" data-live-search="true" onChange="filterByDayWise(this.value)">
										<option value=""></option>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="rclient" class="form-control selectpicker" data-live-search="true" onChange="filterByClient(this.value)">
										<option value=""></option>
										<?php
											if($client_list)
											{
...
<?php init_tail(); ?>
	<script>
		initDataTable('.table-roster', window.location.href, [1], [1]);
		...
		function filterByClient(cid)
		{
            ...
            table.destroy();
            var tAPI = initDataTable('.table-roster', '<?= admin_url() ?>roster/filterByClient?client_id='+cid+'&filter='+obj, [1], [1]); 
            tAPI.ajax.reload();
		}
