				...
				<div class="panel_s">
					<div class="panel-body">
                        ...
                        <?php render_datatable(array(
    							...
    							_l('Status'),
    							_l('Action')
							),'ndis_privateclientserviceagreementcloclientdata_list'); 
						?>
                        <!--
...
<?php init_tail(); ?>
	<script>
        var client_id = 0;
        var clo_id = '';
		initDataTable('.table-ndis_privateclientserviceagreementcloclientdata_list', '<?= admin_url() ?>reports/loadNdisPrivateClientsServiceAgreementClientsData?client_id='+client_id+'&clo_id='+clo_id,[1],[1]);//'+clo_id+'/'+client_id, [1], [1])
    /* Filter By Client */
    ...
    function getcloclientserviceagreementreport(client_id,clo_id) 
    {
        ...
        var table = $('.table-ndis_privateclientserviceagreementcloclientdata_list').DataTable(); 
        table.destroy();
        var tAPI = initDataTable('.table-ndis_privateclientserviceagreementcloclientdata_list', '<?= admin_url() ?>reports/loadNdisPrivateClientsServiceAgreementClientsData?client_id='+client_id+'&clo_id='+clo_id,[1],[1]);
        tAPI.ajax.reload();
    ...
    function loginClientForReport(data) {
        ...
        window.open(base_url+'/client/my-service-agreements/private-clients-service-agreement/'+data.token, '_blank');
    }
