				...
				<div class="panel_s">
					<div class="panel-body">
                        ...
                        <?php render_datatable(array(
    							...
    							_l('Employee Name'),  
    							_l('Client Name'),
    							_l('Incident Date / Time'),
    							_l('Create Date'), 
    							_l('Action')
							),'loadReportIncidentDatadata_list'); 
						?>
                        <!--
...
<?php init_tail(); ?>
	<script>
        var client_id = 0;
        var clo_id = '';
		initDataTable('.table-loadReportIncidentDatadata_list', '<?= admin_url() ?>reports/loadReportIncidentData?client_id='+client_id+'&clo_id='+clo_id,[1],[1]);//'+clo_id+'/'+client_id, [1], [1])
    /* Filter By Client */
    ...
    function getcloclientserviceagreementreport(client_id,clo_id) 
    {
        ...
        var table = $('.table-loadReportIncidentDatadata_list').DataTable(); 
        table.destroy();
        var tAPI = initDataTable('.table-loadReportIncidentDatadata_list', '<?= admin_url() ?>reports/loadReportIncidentData?client_id='+client_id+'&clo_id='+clo_id,[1],[1]);
        tAPI.ajax.reload();
