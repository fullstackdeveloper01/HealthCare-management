				...
				<div class="panel_s">
					<div class="panel-body">
                        ...
                        <?php render_datatable(array(
    							...
    							_l('Status'),
    							_l('Lock/Unlock')
							),'serviceagreementcloclientdata_list'); 
						?>
                        <!--
...
<?php init_tail(); ?>
	<script>
        var client_id = 0;
        var clo_id = '';
		initDataTable('.table-serviceagreementcloclientdata_list', '<?= admin_url() ?>clients/loadServiceAgreementClientsData?client_id='+client_id+'&clo_id='+clo_id,[1],[1]);//'+clo_id+'/'+client_id, [1], [1])
    /* Filter By Client */
    ...
    function getcloclientserviceagreementreport(client_id,clo_id) 
    {
        ...
        var table = $('.table-serviceagreementcloclientdata_list').DataTable(); 
        table.destroy();
        var tAPI = initDataTable('.table-serviceagreementcloclientdata_list', '<?= admin_url() ?>clients/loadServiceAgreementClientsData?client_id='+client_id+'&clo_id='+clo_id,[1],[1]);
        tAPI.ajax.reload();
        ...
        if(client_id!=''){
            ...
            serviceagreementclientdata_table = $('#serviceagreementcloclientdata_list').DataTable({ 
                ...
                "searching": false,
                "ajax": {
                    "url": "<?php echo base_url('admin/clients/loadServiceAgreementClientsData')?>?client_id="+client_id+"&clo_id="+clo_id,
                    "type": "POST",
                    "dataType": "json",
                    "data":{},
                    "data": function ( data ) {
