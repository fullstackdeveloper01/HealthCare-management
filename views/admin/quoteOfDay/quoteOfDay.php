...
<div id="wrapper">
	<div class="content">
		<div class="row">
			<div class="col-md-4">
				<div class="panel_s">
				    <?= form_open(admin_url('quoteOfDay/add/'.$article->id));  ?>
    					<div class="panel-body">
    					   ...
    					   <div class="form-group">
    					       <?= _l('By'); ?>
    					       <input type="text" required autocomplete="off" class="form-control" value="<?= $article->quote_by; ?>" name="quote_by" required>
    					   </div>
    					   <div class="form-group">
