			...
			<div class="col-md-9">
				<div class="panel_s">
    				<div class="panel-body">
    				    <?= form_open(admin_url('properties/updatePropertyDoc/'.$doc_res->id));  ?> 
    					    <h4 class="customer-profile-group-heading"><?= _l('Upload Document'); ?></h4>
						    <hr class="hr-panel-heading" />
						    <div class="row form-group">
        					    <div class="col-md-4">
        					       <?= _l('Title'); ?><span class="text-danger">*</span>
        					       <input type="text" class="form-control" required value="<?= $doc_res->title; ?>" name="title">
        					       <input type="text" class="hide" name="property_id" value="<?= $article->id; ?>">
        					    </div>
        					    <div class="col-md-8">
        					       <?= _l('Description'); ?><span class="text-danger">*</span>
        					       <textarea name="description" class="form-control" rows="3" required> <?= $doc_res->description; ?></textarea>
        					    </div>
    					    </div>
    					    <div class="row form-group">
        					    <div class="col-md-1">
        					       <?= _l('Required'); ?>
        					       <input type="checkbox"  name="required" <?= ($doc_res->required == 1)?"checked":""; ?> value="1" />
        					    </div>
        					    <div class="col-md-4">
