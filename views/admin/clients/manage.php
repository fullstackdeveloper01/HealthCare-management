               ...
               <div class="panel-body">
                  ...
                  <div class="_buttons">
                     ...
                     <div class="col-md-3 pull-right">
                        <select class="form-control" id="report_type_client" onChange="clientFilter()">
                     ...
                     <div class="col-md-3 pull-right">
                        <select class="form-control" id="client_status" onChange="clientFilter()">
                  ...
                  <div class="row mbot15">
                    <div class="col-md-12">
                        <h4 class="no-margin"><?php echo _l('Clients Summary'); ?></h4>
                    </div>
                    <div class="col-md-4 col-xs-6 border-right">
                        <h3 class="bold"><?php echo $this->db->get_where(db_prefix().'contacts', array('role' => 2))->num_rows(); ?></h3>
                        <span class="text-dark"><?php echo _l('Summary total'); ?></span>
                    </div>
                    <div class="col-md-4 col-xs-6 border-right">
                        <h3 class="bold" id="client_status_active"><?php echo $this->db->get_where(db_prefix().'contacts', array('role' => 2, 'active' => 1))->num_rows(); ?></h3>
                        <span class="text-success"><?php echo _l('Active Clients'); ?></span>
                    </div>
                    <div class="col-md-4 col-xs-6 border-right">
                        <h3 class="bold" id="client_status_inactive"><?php echo $this->db->get_where(db_prefix().'contacts', array('role' => 2, 'active' => 0))->num_rows(); ?></h3>
                        <span class="text-danger"><?php echo _l('Inactive Active Clients'); ?></span>
                    </div>
                     <?php /*
                  ...
                  <!-- /.modal -->
                  <div class="checkbox">
                     <input type="checkbox" checked id="exclude_inactive" name="exclude_inactive" value="1">
...
<script>
   $(function(){
      ...
      console.log(CustomersServerParams['exclude_inactive']);
      var client_status = $('input[name="exclude_inactive"]').val();
       var tAPI = initDataTable('.table-clients', admin_url+'clients/table?client_status='+client_status, [0], [0], CustomersServerParams,<?php echo hooks()->apply_filters('customers_table_default_order', json_encode(array(1,'Desc'))); ?>);
      //var tAPI = initDataTable('.table-clients', admin_url+'clients/table?client_status='+client_status, [1], [1],'',[0,'desc']); 
      $('input[name="exclude_inactive"]').on('change',function(){
         if(this.value==1){
            $('input[name="exclude_inactive"]').val('');
         }else{
            $('input[name="exclude_inactive"]').val(1);
         }
         var table = $('.table-clients').DataTable(); 
         table.destroy();
         var tAPI = initDataTable('.table-clients', admin_url+'clients/table?client_status='+this.value, [0], [0],CustomersServerParams,<?php echo hooks()->apply_filters('customers_table_default_order', json_encode(array(1,'Desc'))); ?>);
           tAPI.ajax.reload();
       });
   });
   ...
   {
      var report_type = $('#report_type_client option:selected').val();
      var client_status = $('#client_status option:selected').val();
      var CustomersServerParams = {};
      CustomersServerParams['exclude_inactive'] = '[name="exclude_inactive"]:checked';
      var table = $('.table-clients').DataTable(); 
      table.destroy();
      var tAPI = initDataTable('.table-clients', '<?= admin_url() ?>clients/table?report_type='+report_type+"&client_status="+client_status, [0], [0],CustomersServerParams,<?php echo hooks()->apply_filters('customers_table_default_order', json_encode(array(1,'Desc'))); ?>); 
      tAPI.ajax.reload();
   ...
   function changeStatus(obj,id){
      var total_inactive = $('#client_status_inactive').text();
      var total_active = $('#client_status_active').text();
      if(obj==1){
      ...
      $('#client_status_inactive').text(total_inactive);
      $('#client_status_active').text(total_active);
   }
</script>
</body>
</html>
