         ...
         <div class="panel-body">
            ...
            <div class="header-wrap bg-white">
                <div class="d-flex align-items-center">
                    <div><h4>Recently Added Clients</h4></div>
                    <div class="ml-auto align-items-center">
                        <div class="dl">
                            <a href="<?= admin_url('clients'); ?>">View all</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
					...
					<tbody>
					    <?php
					        $clientList = $this->db->select('email,userid,firstname,lastname,phonenumber,datecreated')->limit(5)->order_by('id', 'desc')->get_where(db_prefix().'contacts', array('role' => 2, 'active' => 1))->result();
					        if($clientList)
					        {
					            $sn = 1;
					            foreach($clientList as $res)
					            {
					                ?>
					                    <tr>
            								<td><?= $sn++; ?></td>
					        ...
					        {
					            ?>
					                <tr class="odd"><td valign="top" colspan="7" class="dataTables_empty">No entries found</td></tr>
					            <?php
					        }
					    ?>
					</tbody>
