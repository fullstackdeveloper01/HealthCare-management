                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="box_one_Link" name="box_one_Link" class="form-control">
                                <option value=""></option>
                                <option value="clients" <?= ($box_result[0]->link == "clients")?"selected":"";?>>Client List</option>
                                ...
                                <option value="staff" <?= ($box_result[0]->link == "staff")?"selected":"";?>>Admin Clients</option>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="box_two_Link" name="box_two_Link" class="form-control">
                                <option value=""></option>
                                <option value="clients" <?= ($box_result[1]->link == "clients")?"selected":"";?>>Client List</option>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="box_third_Link" name="box_third_Link" class="form-control">
                                <option value=""></option>
                                <option value="clients" <?= ($box_result[2]->link == "clients")?"selected":"";?>>Client List</option>
                                ...
                                <option value="staff" <?= ($box_result[2]->link == "staff")?"selected":"";?>>Admin Clients</option>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="box_fourth_Link" name="box_fourth_Link" class="form-control">
                                <option value=""></option>
                                <option value="clients" <?= ($box_result[3]->link == "clients")?"selected":"";?>>Client List</option>
                                ...
                                <option value="staff" <?= ($box_result[3]->link == "staff")?"selected":"";?>>Admin Clients</option>
