                    ...
                    <div class="header-wrap p-10 bg-white">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <div class="dl">
                                    <a href="<?= $_SERVER['HTTP_REFERER']; ?>" class="back">Back</a> 
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-10 bg-white">
                        <table class="table dt-table table-doc" data-order-col="1" data-order-type="desc">
                            ...
                            <tr>
                                ...
                                <td><?= $user_timezone = $this->db->get_where(db_prefix().'contacts', array('userid' => get_client_user_id()))->row('user_timezone'); ?></td>
                            </tr>
                            <tr>
...
<script>
    function changeAppointmentStatus(Id)
    {
        ...
        if(result)
        {
    	    ...
    	    $.ajax({
    	        url: '<?= site_url()?>clients/changeStatus',
    	        type: 'POST',
    	        data: str,
    	        dataType: 'json',
    	        cache: false,
