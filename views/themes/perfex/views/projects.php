                     ...
                     <div>
                        <form class="form-inline">
                           ...
                           <div class="form-group">
                              <label>Sort</label>
                              <select class="form-control" onChange="filterProperty(this.value)">
...
<script>
	...
	{
		var str = "val="+val+"&"+csrfData['token_name']+"="+csrfData['hash'];
		$.ajax({
			url: '<?= site_url()?>clients/filterProperty',
			type: 'POST',
			data: str,
			dataType: 'json',
			cache: false,
