...
<div class="container pt-140 single-ticket">
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="panel_s single-ticket-reply-area">
                ...
                <div class="panel-heading">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <span><?php echo _l('clients_ticket_single_add_reply_heading'); ?></span>
                        <div class="float-right">
                        <button type="button" class="btn btn-primary mb-1" id="ticket_back">Back</button>
                        <div class="clearfix select-blue">
                            <select class="form-control selectpicker" name="status_change" id="status_change" data-live-search="true" onchange="changeCloTicketStatus(<?= $ticket->ticketid; ?>,this.value);">
                                <?php
                                $statuseslist = $this->db->get(db_prefix() . 'tickets_status')->result();
                                if ($statuseslist) {
                                    foreach ($statuseslist as $st_val) {
                                ?>
                                        <option <?php if ($ticket->status == $st_val->ticketstatusid) {
                                                    echo "selected";
                                                } ?> value="<?= $st_val->ticketstatusid; ?>"><?= $st_val->name; ?></option>
                                <?php
                                    }
                                }
                                ?>
                ...
                <div class="panel-footer attachments_area mb-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mtop20 mbot20 text-center mb-1">

                            <button class="btn btn-success" type="submit" data-form="#ticket-reply" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>"><?php echo _l('ticket_single_add_reply'); ?></button>
            ...
            <div class="panel_s">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <?php if (count($ticket->attachments) > 0) {
                            ...
                            <a href="<?php echo site_url('download/file/ticket/' . $attachment['id']); ?>" class="display-block mbot5 bold text-black">
                ...
                <div class="panel-body <?php if ($ticket->contactid == 0) {
                                            echo 'client-reply';
                                        } ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 border-right">
                            ...
                            <?php if ($ticket->contactid == NULL || $ticket->contactid == 0) { ?>

                                <p><?php echo $ticket->submitter; ?></p>
                                <p class="text-muted">

                                    <!-- <?php echo (get_user_id_role()!=4)?'Client Liaison Office':'Human resourcess'; ?> -->
                        ...
                        <div class="col-md-9">
                            ...
                            <?php if (count($ticket->attachments) > 0) {
                                ...
                                foreach ($ticket->attachments as $attachment) { ?>
                                    ...
                                    <a href="<?php echo site_url('uploads/ticket_attachments/' . $attachment['ticketid'] . '/' . $attachment['file_name']); ?>" class="display-block mbot5 bold text-black" target="_blank">
                                        ...
                                        <?php }else{
                                         ?>
                                         <br>
                                         <img src="<?php echo base_url("/assets/images/document.svg"); ?>"  class="rounded mr-1"  width="50px"  />

                                         <!-- <img width='50px' src='".base_url("/assets/images/document.svg")."/assets/images/document.svg' alt='Avatar' class='rounded mr-1' /></a> -->
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    ?>
                        ...
                        <a href="<?php echo site_url('download/file/ticket/' . $attachment['id']); ?>" class="inline-block mbot5  bold text-black">
                    ...
                    <div class="panel-body <?php if ($reply['contactid'] == 0) {
                                                echo 'client-reply';
                                            } ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 border-right">
                                ...
                                <p class="text-muted">
                                    ...
                                    <?php if ($reply['contactid'] != 0) {

                                        echo (get_user_id_role()!=4)?'Client Liaison Office':'Human resources'; 
                                    }
                            ...
                            <div class="col-md-9">
                                ...
                                ?>
                                        ...
                                        <a href="<?php echo site_url('uploads/ticket_attachments/' . $attachment['ticketid'] . '/' . $attachment['file_name']); ?>" class="inline-block mbot5 bold text-black" target="_blank">
                                         ...
                                         ?>
                                         <br>
                                         <img width="50px" src="<?php echo base_url('assets/images/document.svg'); ?>"  class="rounded mr-1" />
...
<script>
    function changeCloTicketStatus(id, status_change) {
        $.ajax({
            url: '<?= base_url() ?>clients/change_status_ajax/' + id + '/' + status_change,
            type: 'get',
            datatype: 'json',
    ...
    $("#ticket_back").click(function(){
        ...
        localStorage.setItem('openModal', 'supportlistmodel');
        // setTimeout(function() {
		// 	$("#supportlistmodel").modal('show');
		// }, 1000);
