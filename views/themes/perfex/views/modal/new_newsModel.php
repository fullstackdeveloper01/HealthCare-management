                ...
                <?php echo form_open_multipart('clients/addarticle',array('id'=>'updateNews', 'class' => 'form-horizontal', 'autocomplete' => 'off')); ?>
            ...
            <!--         <?php if(isset($article)){ ?>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            ...
                            <?php $contents = $article->description; ?>
                            <div class="clearfix">
                                <div class="col-md-12">
                                    <?php echo render_textarea('description_edit','',$contents,array(),array(),'','tinymce tinymce-manual required'); ?>
                                </div>
                            </div>
