...
<table class="table dt-table table-tickets custom-table-2" data-order-col="<?php echo (get_option('services') == 1 ? 7 : 6); ?>" data-order-type="desc">
  ...
  <thead>
    ...
    <?php if(get_user_id_role()!=4) {  if($show_submitter_on_table) { ?>
...
<!-- 
  ...
  <tbody>
    ...
    <?php foreach($tickets as $ticket){ ?>
      ...
      <tr class="<?php if($ticket['clientread'] == 0){echo 'text-danger';} ?>">
        ...
        <a href="<?php echo site_url('clients/ticket/'.$ticket['ticketid']); ?>"><?php echo clientname($ticket['userid']); ?></a>
        ...
        <td>
          ...
          <a href="<?php echo site_url('clients/ticket/'.$ticket['ticketid']); ?>">
            <?php 
              ...
              {
                echo mb_substr($ticket['subject'],0,50).'...';
              }
              else
              {
                 echo $ticket['subject'];
 ...
 -->
        ...
        <td>
          ...
          <span class="btn btn-xs text-white" style="background:<?php echo $ticket['statuscolor']; ?>">
